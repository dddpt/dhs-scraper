...
- ville de zurich https://hls-dhs-dss.ch/fr/articles/000171/2015-01-25/
    -> link as a source
    -> endonymes/exonymes
- Amédée V de Savoie https://hls-dhs-dss.ch/fr/articles/017857/2013-04-04/
    -> link in bref
    -> unknown birth date
"""
...
if False:
    ...
    gustave = DhsArticle(url="https://hls-dhs-dss.ch/fr/articles/003848/2002-06-12/")
    gustave.parse_article()

    zurich = DhsArticle(url="https://hls-dhs-dss.ch/fr/articles/000171/2015-01-25/")
    zurich.parse_article()
